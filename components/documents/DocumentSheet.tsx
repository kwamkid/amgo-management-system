...
export const printCss = `
  @media print {
    ...
    #${SHEET_ID} {
      ...
      width: 210mm;
      /* ── ทำไมต้อง 100vh ลบอีก 1px ────────────────────────────────
         ในโหมดพิมพ์ vh = ความสูง "กรอบหน้าจริง" หลังหักขอบที่กล่องพิมพ์
         กำหนด · ใส่ 297mm ตายตัวจะพลาด 2 ทาง:
           1. ผู้ใช้ตั้ง Margins เป็น Minimum/Default → กรอบหน้าเล็กกว่า A4
              แผ่นสูงเต็ม 297mm จึงล้นออกไปเป็นหน้าที่ 2 ที่ว่างเปล่า
           2. 297mm = 1122.5px เบราว์เซอร์ปัดเป็น 1123px แล้วล้นครึ่งพิกเซล
         ลบ 1px ทิ้งเพื่อกันการปัดเศษ — ตาเปล่ามองไม่เห็น แต่ไม่มีวันล้น
         (เจ้าของเจอหน้า 2 ว่าง 22 ส.ค. · เครื่องทดสอบผมจับอาการไม่ได้
          จึงแก้แบบกันไว้ทุกทาง ไม่ใช่แก้ตามที่วัดเจอ) */
      min-height: calc(100vh - 1px);
      /* กันไม่ให้อะไรงอกเป็นหน้าถัดไปจากตัวแผ่นเอง */
      overflow: hidden;
